...
class JSONChatClient(ChatClient):
        ...
        while self.running:
            try:
                ...
                while b'\n' in buffer: # Process each complete JSON message
                    ...
                    threading.Thread(target=self.handle_json_response, args=(message.decode("utf-8"),), daemon=True).start()
    ...
    def send_login(self, username, password):
        ...
        self.send_json_request("LOGIN", {"username": username, "password_hash": hashed_password.decode('utf-8')})
    ...
    def send_create_account(self, username, password):
        ...
        self.send_json_request("CREATE_ACCOUNT", {"username": username, "password_hash": hashed_password.decode('utf-8')})
    ...
    def send_list_accounts(self, filter_text=""):
        ...
        self.send_json_request("LIST_ACCOUNTS", {"maximum_number": self.max_users, "offset_account_id": offset_id, "filter_text": filter_text})
    ...
    def handle_json_response(self, message):
        ...
        try:
            ...
            if not success:
                ...
                self.log_error(f"Operation {operation} failed: {message}")
